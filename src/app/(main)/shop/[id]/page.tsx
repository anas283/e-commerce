...
export default function ShopDetail() {
  ...
  return (
    <div className="w-full max-w-xl mx-auto border-t pt-5 px-4 lg:px-0">
      <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem>
      ...
      <div className="mt-5 flex flex-col gap-5">
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className={tshirt === Tshirt1Image ?  `h-[106px] rounded-[20px] overflow-hidden border border-black`:`h-[106px] rounded-[20px] overflow-hidden`}
              onClick={() => setTshirt(Tshirt1Image)}
            > 
              <Image src={Tshirt1Image} alt="star" className="object-cover w-full h-full" />
            </div>
            <div className={tshirt === Tshirt2Image ?  `h-[106px] rounded-[20px] overflow-hidden border border-black`:`h-[106px] rounded-[20px] overflow-hidden`}
              onClick={() => setTshirt(Tshirt2Image)}
            > 
              <Image src={Tshirt2Image} alt="star" className="object-cover w-full h-full" />
            </div>
            <div className={tshirt === Tshirt3Image ?  `h-[106px] rounded-[20px] overflow-hidden border border-black`:`h-[106px] rounded-[20px] overflow-hidden`}
          ...
          <div className="pt-4 grid grid-cols-3 gap-3">
            <div>
              <div className="bg-[#F0F0F0] rounded-full h-11 flex justify-between items-center px-3">
                <Minus className="" />
                <div>
                  <Input value={1} className="text-sm font-medium border-0 p-0 shadow-none w-4 text-center focus-visible:ring-0" />
                </div>
                <Plus />
              </div>
            </div>
